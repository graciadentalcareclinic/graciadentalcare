...
const AppointmentForm: React.FC = () => {
  ...
  const doctorAvailability: Record<string, number[]> = {
    'Charly Esmond Siagian - Dokter Gigi Spesialis Periodonsia': [1, 3, 6], // Mon, Wed, Sat
  'Desyanne Winardi - Dokter Gigi Spesialis Ortodonsia': [1, 2, 3, 4, 5], // Mon-Fri
  'Bradley Melthon Siagian - Dokter Gigi Umum': [1, 2, 3, 4, 5], // Mon-Fri
  'Erwina Siagian - Dokter Gigi': [1, 2, 3, 4, 5], // Mon-Fri
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Charly Esmond Siagian - Dokter Gigi Spesialis Periodonsia">Charly Esmond Siagian - Dokter Gigi Spesialis Periodonsia</option>
                    <option value="Desyanne Winardi - Dokter Gigi Spesialis Ortodonsia">Desyanne Winardi - Dokter Gigi Spesialis Ortodonsia</option>
                    <option value="Bradley Melthon Siagian - Dokter Gigi Umum">Bradley Melthon Siagian - Dokter Gigi Umum</option>
                    <option value="Erwina Siagian - Dokter Gigi">Erwina Siagian - Dokter Gigi</option>
                  </select>
                </div>
